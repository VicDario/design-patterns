...
interface Visitor {
  ...
  visitFerrisWheel(ferrisWheell: FerrisWheel): void;
}
...
class ChildVisitor implements Visitor {
  ...
  visitFerrisWheel(ferrisWheell: FerrisWheel): void {
    console.log(
      `Niño en la rueda de la fortuna: Precio con descuento $${
        ferrisWheell.getPrice() * 0.6
      }`
    );
  }
}
...
class AdultVisitor implements Visitor {
  ...
  visitFerrisWheel(ferrisWheell: FerrisWheel): void {
    console.log(
      `Adulto en la rueda de la fortuna: Precio con descuento $${ferrisWheell.getPrice()}`
    );
  }
}
...
class SeniorVisitor implements Visitor {
  visitRollerCoaster(rollerCoaster: RollerCoaster): void {
    console.log(
      `Adulto en montaña rusa: Precio con descuento $${
  ...
  visitHauntedHouse(hauntedHouse: HauntedHouse): void {
    console.log(
      `Adulto en casa del terror: Precio con descuento $${
  ...
  visitFerrisWheel(ferrisWheell: FerrisWheel): void {
    console.log(
      `Adulto en la rueda de la fortuna: Precio con descuento $${
        ferrisWheell.getPrice() * 0.85
      }`
    );
  }
}
